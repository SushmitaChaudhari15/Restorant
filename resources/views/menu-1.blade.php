				...
				<div role="tabpanel" class="row tab-pane fade in active show" id="tab-1">
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-1.jpg')}}" alt="pizza"></a></div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-2.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-3.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-11.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-10.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-6.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-7.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-8.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
								<a href="shop-detail.html" class="iteam-name">Chicken Breast </a>
								<ul>
									<li>Chicken</li>
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-9.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
								<a href="shop-detail.html" class="iteam-name">Chicken Breast </a>
								<ul>
									<li>Chicken</li>
					...
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							...
							<div class="menu-detail">
								...
								<p class="iteam-desc">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or</p>
								<!-- <a href="shop-detail-2.html" class="iteam-order">order now</a> -->
							</div>
						</div>
					</div>
				</div>
				<div role="tabpanel" class="row tab-pane fade" id="tab-4">
					<div class="col-xl-4 col-lg-4 col-md-4">
						<div class="menu-list-box">
							<div class="list-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/list-10.jpg')}}" alt="pizza"></a></div>
							<div class="menu-detail">
								<a href="shop-detail-2.html" class="iteam-name">Fettucini</a>
								<ul>
									<li>Chicken</li>
									<li>Olive Oil</li>
									<li>Salt</li>
