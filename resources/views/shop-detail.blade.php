...
@section('container')
	...
	<section class="page-banner" style="background: #121619 url({{ asset('admin_assets/images/blog-9.jpg')}}) no-repeat center / cover;">
		<div class="container">
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12">
					<div class="page-title">
						...
						<ul>
							<li><a href="index-2.html" class="page-name">Home</a></li>
				...
				<div class="col-lg-5 col-md-6 col-12">
					<div class="align-center mb-md-30">
					    <ul id="glasscase" class="gc-start">
					        <li><img src="{{ asset('admin_assets/images/p-1.png')}}" alt="pizzon" /></li>
					        <li><img src="{{ asset('admin_assets/images/p-2.png')}}" alt="pizzon" /></li>
					        <li><img src="{{ asset('admin_assets/images/p-3.png')}}" alt="pizzon" /></li>
					        <li><img src="{{ asset('admin_assets/images/p-4.png')}}" alt="pizzon" data-gc-caption="Your caption text" /></li>
					        <li><img src="{{ asset('admin_assets/images/p-5.png')}}" alt="pizzon" /></li>
					        <li><img src="{{ asset('admin_assets/images/p-6.png')}}" alt="pizzon" /></li>
					    </ul>
					</div>
				</div>
				<div class="col-xl-7 col-lg-7 col-md-7">
					<div class="shop-detail">
						...
						<div class="quantity-product">
							...
							<a href="#" class="add-cart"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Add to cart</a>
						</div>
						<div class="wiselist">
							<ul class="compare">
								...
								<ul>
									<li>
										<div class="comment-user">
											<img src="{{ asset('admin_assets/images/comment-img1.jpg')}}" alt="comment-img">
										</div>
									...
									<li>
										<ul>
											<li>
												<div class="comment-user">
													<img src="{{ asset('admin_assets/images/comment-img2.jpg')}}" alt="comment-img">
												</div>
												<div class="comment-detail">
													<span class="commenter">
											...
											<li>
												<div class="comment-user">
													<img src="{{ asset('admin_assets/images/comment-img3.jpg')}}" alt="comment-img">
												</div>
												<div class="comment-detail">
													<span class="commenter">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xl-3 col-lg-3 col-md-4 text-center pt-20">
					<div class="menu-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/rel-1.png')}}" alt="menu" class="menu-image"></a></div>
				...
				<div class="col-xl-3 col-lg-3 col-md-4 text-center pt-20">
					<div class="menu-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/rel-2.png')}}" alt="menu" class="menu-image"></a></div>
					<a href="shop-detail.html" class="menu-title text-uppercase">VEGETARIAN</a>
					<p class="menu-des">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
					<span class="menu-price">$20.50</span>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-4 text-center pt-20">
					<div class="menu-img"><a href="shop-detail.html"><img src="{{ asset('admin_assets/images/rel-3.png')}}" alt="menu" class="menu-image"></a></div>
